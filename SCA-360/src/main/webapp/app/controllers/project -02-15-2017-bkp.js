...
.controller('dashboardController', function($scope,$http) {
	...
	$scope.loadCustomersForDB  = function() 
	 ...
	 $scope.loadAllCustomerDetails = function(accountname,form)
			  {	
				 ...
				 $.post("getAllCustmerDetailsSavedOnId.do",{account:accountname},function(json)
				{
					...
					//alert(JSON.stringify(q.imagename.length));
							 ...
							 /*if(getImage!=null)
							   {
								   ...
								   {
									   var img = $('<img src="'+getImage+'" width="100" height="180"/>', {id: 'dynamic',width:100,height:180 });
...
.controller("newCaseManagement",function($scope,$http,$filter,$rootScope,$timeout,$route,$state)
{
  ...
  $scope.getCaseData = function(addCase,form)
		...
		$scope.chngReqSpeed = function(rpm,ratio,indexReq)
		{
			...
			var reqOutputSpeed;
			if(rpm == null || rpm == "Infinity") { rpmVal = 0; }else {rpmVal = rpm; } 
			if(ratio == null || ratio == "Infinity")  { ratioVal = 0; }else {ratioVal = ratio; }
			//alert(rpmVal);
			//alert(ratioVal);
			...
			$scope.dataField[indexReq].requiredOutputSpeed = reqGetSpeed.toFixed(2);
...
$scope.getGearProductType = function()
	  {
		 ...
		 // $scope.gearProductData = [{ id: '1', gearProduct: 'Cyclo Drive' }, { id: '2', gearProduct: 'Cyclo TL' },{ id: '3', gearProduct: 'Cyclo SK Series' }, { id: '4', gearProduct: 'Cyclo Planetary' },{ id: '5', gearProduct: 'Fine Cyclo' },{ id: '6', gearProduct: 'CYCLO WITH TORQUE LIMITER' }]; gearProduct
	  ...
	  $scope.loadReqOPSpeed = function(outputSpeed,index)
	  {
		  var index = this.$index;
		  
		  /*if(isNaN(rpm)){var reqRpm = 0;}else{var reqRpm = rpm;}
		  if(isNaN(ratio)){var reqRatio = 0;}else{var reqRatio = ratio;}
		  var reqSpeed = (reqRpm/reqRatio);*/
		   if(isNaN(outputSpeed) || outputSpeed == "Infinity"){var fixOPSpeed = 0;}else{var fixOPSpeed = outputSpeed;}
		  //alert(fixOPSpeed);
		 $scope.dataField[index].requiredOutputSpeed = fixOPSpeed.toFixed(2);
		 $('#RequiredOutputSpeed').trigger('blur');
		 $scope.$apply();
	  }
		 ...
		 $.getJSON("getRpmforCase.do",{pole:pole,frequency:hz},function(json)
					{
						...
						$scope.dataCompetitor[index].requiredOutputSpeed = reqGetSpeed.toFixed(2);
						 $('#RequiredOutputSpeedComp').trigger('blur');
	  ...
	  $scope.loadReqOPSpeedComp = function(outputSpeed,index)
	  {
		  var index = this.$index;
		  ...
		  var reqSpeed = (reqRpm/reqRatio);*/
		   if(isNaN(outputSpeed) || outputSpeed == "Infinity"){var fixOPSpeed = 0;}else{var fixOPSpeed = outputSpeed;}
		  //alert(fixOPSpeed);
		 $scope.dataCompetitor[index].requiredOutputSpeed = fixOPSpeed.toFixed(2);
		 $('#RequiredOutputSpeedComp').trigger('blur');
		 $scope.$apply();
	  }
		 ...
		 $.getJSON("getRpmforCase.do",{pole:pole,frequency:hz},function(json)
					{
						...
						$scope.dataSumitomo[index].requiredOutputSpeed = reqGetSpeed.toFixed(2);
						 $('#RequiredOutputSpeedSumit').trigger('blur');
						 $scope.$apply();
					});
		  
		  $scope.$apply();
	  }
	  $scope.loadReqOPSpeedSumit = function(outputSpeed,index)
	  {
		  var index = this.$index;
		  ...
		  var reqSpeed = (reqRpm/reqRatio);*/
		   if(isNaN(outputSpeed) || outputSpeed == "Infinity"){var fixOPSpeed = 0;}else{var fixOPSpeed = outputSpeed;}
		  //alert(fixOPSpeed);
		 $scope.dataSumitomo[index].requiredOutputSpeed = fixOPSpeed.toFixed(2);
		 $('#RequiredOutputSpeedSumit').trigger('blur');
		 $scope.$apply();
	  }
		 ...
		 $.getJSON("getRpmforCase.do",{pole:pole,frequency:hz},function(json)
					{
						...
						$scope.dataQuery[index].requiredOutputSpeed = reqGetSpeed.toFixed(2);
						 $('#RequiredOutputSpeedTech').trigger('blur');
						 $scope.$apply();
					});
		  
		  $scope.$apply();
	  }
	  $scope.loadReqOPSpeedTech = function(outputSpeed,index)
	  {
		  var index = this.$index;
		  ...
		  var reqSpeed = (reqRpm/reqRatio);*/
		   if(isNaN(outputSpeed) || outputSpeed == "Infinity"){var fixOPSpeed = 0;}else{var fixOPSpeed = outputSpeed;}
		  //alert(fixOPSpeed);
		 $scope.dataQuery[index].requiredOutputSpeed = fixOPSpeed.toFixed(2);
		 $('#RequiredOutputSpeedTech').trigger('blur');
		 $scope.$apply();
	  }
...
$scope.addFormField = function() 
	{
		...
		$indexTab1++;
	    $scope.dataField.push({'id':$indexTab1,'gm':'0','model':'0','ambientTemp':'40','pole':'4','rpm':'1450','phase':'3','motorType':'NO','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','voltage':'230','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','conf':'0','mount':'0','oshaft':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'ishaft':'0','oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'});
                     ...
                     //var dtexp = json['maincaseform'][0].dateExp.split('T');
				      var gridVal = json['value'];
				          if(gridVal==0)
				    	  {
				        	  ...
				        	  $scope.addDesp=json['description'][0]; 
							  $indexTab1=1;
							  $scope.dataField=[{'id':$indexTab1,'gm':'0','model':'0','ambientTemp':'40','rpm':'1450','pole':'4','phase':'3','motorType':'NO','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','voltage':'230','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','conf':'0','mount':'0','oshaft':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'ishaft':'0','oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'}];
							  $scope.stepsModel = [];
							  cusImage = new FormData();
			...
			$.post("loadingCasessTab4.do",function(json)
				...
				if(gridVal==0)
				{
					//alert(gridVal);
					  ...
					  $scope.addDespSpare=json['description'][0]; 
					  $indexTab4=1;
					  $scope.dataPart=[{'id':$indexTab4,'gm':'0','ambientTemp':'40','pole':'4','rpm':'1450','motorType':'NO','voltage':'230','phase':'3','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','model':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1'}];
                      $scope.stepsModelSpare = [];
			...
			$.post("loadingCasessTab5.do",function(json)
				...
				if(gridVal==0)
				{
					//alert(JSON.stringify(json['description'][0]));
					  ...
					  $scope.addDespTech=json['description'][0];
					  $indexTab5=1;
					  $scope.dataQuery=[{'id':$indexTab5,'gm':'0','model':'0','ambientTemp':'40','pole':'4','rpm':'1450','motorType':'NO','voltage':'230','phase':'3','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','conf':'0','mount':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'ishaft':'0','oshaft':'0','oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'}];
                      $scope.stepsModelTech = [];
								...
								if(data==true)
									{
										...
										$scope.remarks = "";
								        $indexTab1=1;
							          $scope.dataField=[{'id':$indexTab1,'gm':'0','model':'0','ambientTemp':'40','rpm':'1450','motorType':'NO','voltage':'230','pole':'4','phase':'3','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','conf':'0','mount':'0','oshaft':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'ishaft':'0','oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'}];
									    $scope.stepsModel = [];
								        form.$setPristine(true); 
						...
						if(data==true)
							{
								...
								//$scope.remarks = "";
								$indexTab1=1;
							    $scope.dataField=[{'id':$indexTab1,'gm':'0','model':'0','ambientTemp':'40','motorType':'NO','rpm':'1450','voltage':'230','pole':'4','phase':'3','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','conf':'0','mount':'0','oshaft':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'ishaft':'0','oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'}];
								$scope.stepsModel = [];
								cusImage = new FormData();
								form.$setPristine(true); 
								form2.$setPristine(true);
...
$scope.addCompetitorForm = function() 
	{
		...
		$indexTab2++;
		$scope.dataCompetitor.push({'id':$indexTab2,'gm':'0','model':'0','ambientTemp':'40','pole':'4','rpm':'1450','motorType':'NO','voltage':'230','phase':'3','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','dimension':'1','conf':'0','mount':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'ishaft':'0','oshaft':'0','oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'})
						   ...
						   if(data==true)
									{
										...
										$scope.remarksComp = "";
								        $indexTab2=1;
							          $scope.dataCompetitor=[{'id':$indexTab2,'gm':'0','model':'0','ambientTemp':'40','rpm':'1450','motorType':'NO','voltage':'230','pole':'4','phase':'3','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','dimension':'1','conf':'0','mount':'0','ishaft':'0','oshaft':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'}];
                                         $scope.stepsModelComp = [];
										 cusImageComp = new FormData(); 
								        form.$setPristine(true); 
										form2.$setPristine(true);
...
$scope.addSumitomoField = function() 
	{
		...
		$indexTab3++;
	    $scope.dataSumitomo.push({'id':$indexTab3,'gm':'0','model':'0','ambientTemp':'40','pole':'4','phase':'3','rpm':'1450','motorType':'NO','voltage':'230','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','dimension':'1','conf':'0','mount':'0','ishaft':'0','oshaft':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'})
	};
								...
								if(data==true)
									{
										...
										$scope.remarksSumit = "";
								        $indexTab3=1;
							          $scope.dataSumitomo=[{'id':$indexTab3,'gm':'0','model':'0','ambientTemp':'40','rpm':'1450','motorType':'NO','voltage':'230','pole':'4','phase':'3','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','dimension':'1','conf':'0','mount':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'ishaft':'0','oshaft':'0','oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'}];
                                        $scope.stepsModelSumit = [];
										cusImageSumit = new FormData();
								        form.$setPristine(true); 
										form2.$setPristine(true);
...
$scope.addSparePartField = function() 
	{
		...
		$indexTab4++;
	    $scope.dataPart.push({'id':$indexTab4,'gm':'0','ambientTemp':'40','pole':'4','rpm':'1450','phase':'3','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','motorType':'NO','voltage':'230','mtrEfficncyClass':'0','model':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1'})
	};
...
$scope.addtechQueryField = function() 
	{
		...
		$indexTab5++;
	    $scope.dataQuery.push({'id':$indexTab5,'gm':'0','model':'0','ambientTemp':'40','pole':'4','rpm':'1450','phase':'3','motorType':'NO','voltage':'230','application':'A01','gearProduct':'ALTAX','motorKW':'0.1','hertz':'50','protectionGrade': 'IP55','internationalStd': 'CE','mtrEfficncyClass':'0','inverter':'1','motorBrake':'1','motorBrakeVolt':'1','conf':'0','mount':'0','mount2':'0',oshaftInc1:false,oshaftInc2:false,'ishaft':'0','oshaft':'0','oshafty':'0','oshafty2':'4','backStop':'0','rot':'0','hssRadialLoadKn':'0','hssRadialLoadMm':'0','hssAxialLoadKn':'0','sssRadialLoadKn':'0','sssRadialLoadMm':'0','sssAxialLoadKn':'0','dirHssAxial':'0','dirSssAxial':'0'})
	};
...
//==================================================//
angular.module('app')
.controller('CustomerMaster',function($scope,$http){
        ...
        $scope.getLoads = function() {
            var httpRequest = $http({
                ...
                for (var i = 0; i < data.scoreEvents.length; i++) {
                    ...
                    $scope.events[i] = {
                        title: 'SCORE:' + data.scoreEvents[i].score,
                        start: moment(date[0]),
                        allDay: true,
...
*/
        ...
        $scope.getDetailsProduction = function(id, salesOrder, modelno, quantity, assemblyDate, completedDate, startTime, endTime, checkPacking, scheduled, index, testby, completedquantity, modifyFlag, changeFlag) {
            ...
            var date = moment(assemblyDate);
            var date2 = moment(completedDate);

            var selectedDate = moment(date).format('YYYY-MM-DD');

            getSalesOrderObj.assemblyDate = $filter('date')(selectedDate, 'dd-MM-yyyy');
            var selectedDate2 = moment(date2).format('YYYY-MM-DD');

            getSalesOrderObj.completedDate = $filter('date')(selectedDate2, 'dd-MM-yyyy');
        ...
        $scope.getcompletvalidate = function(assemblydate, completedate, id) {
            ...
            for (var i = 0; i <= JSON.stringify($scope.schedulerPopData.length); i++) {
                ...
                if (id != i) {
                    ...
                    var date = assemblydate.split('T');
                    if (new Date(completedate) < new Date(date[0])) {
...
.controller("testReportController", function($scope, $http, $rootScope, $state) {
	...
	var greaseweight=parseInt(finalweight)-parseInt(headweight);
		...
		$scope.calculateOutputRPM1=function(frequency,modelno,measuredOpSpeed1){
			...
			if(measuredFinalWeight1==undefined){}else{
				if(measuredFinalWeight1>measuredGearHeadWeight1){
					$('#invaliddata').hide();
...
angular.module('app')
.controller('serviceInquiryController',function($scope,$http){
	
	$scope.serviceInq = ({'serviceLocation':'0','attachDrawing':'0'})
	////image////
	$scope.stepsModel = [];
...
var ServiceInqAddObj1 = new Object();
	  ...
	  var cusImage = new FormData();
	 $scope.uploadServiceFile = function(files) 
	{
		
		$.each(files, function(i, file) {
               //cusImage.append("pics_"  + i, file); 
			   cusImage.append("userdrawing", file); 
           });
	...
	$scope.submitServiceinq=function(value,form){
		...
		// alert(angular.toJson(ServiceInquiryData));
	...
	$scope.getcasereafernce=function(value){
	...
	$scope.serviceinquiryField = [];
	 ...
	 $scope.addinquiryForm = function() 
			...
			$index++;
			$scope.serviceinquiryField.push({'id':$index})
...
angular.module('app')
    .controller('QAServiceController', function($scope, $http, $rootScope) {
        ...
        $scope.GetQA = function(fromdate,todate,radio) {
			if(todate!=undefined){
...
angular.module('app')
    .controller('QAServiceINTController', function($scope, $http, $rootScope, $state, $route) {
        ...
        $scope.qaIssuesFor1 = [{
            "text": "manufacturing components defects",
            "id": "0"
        }, {
            "text": "Missing part ",
            "id": "1"
        ...
        $scope.LoadQaIntRef = function() {
            ...
            var httpRequest = $http({
               ...
               // alert(JSON.stringify(data.photoPath));
        ...
        $scope.QualIntSubmit = function(form, QuaIssue) {
            ...
            if (!Modeifyimageflag) {
               ...
               // alert(JSON.stringify(Formobj));
                ...
                $http.post("/SCA-360/saveQAIssue.do", cusImage, {
                    withCredentials: true,
                    headers: {
                        'Content-Type': undefined
                    },
...
.controller('ScoreMasterController',function($scope,$http)
		 {
			 $scope.Mounting = [{"text": "CNHM/CNH","id": "0"}, {"text": "CNVM/CNV","id": "1" },{ "text": "CNFM/CNF","id": "2"},
   {"text": "CHHM/CHH","id": "3"}, {"text": "CVVM/CVV","id": "4" },{ "text": "CHVM/CHV","id": "5"}];
			 $scope.master = {};
				$scope.LoadRadio=function(){
				$scope.scoremaster = ({'productTypeCode':'0','subTypeCode':'1'});
				};
				$scope.LoadpresRadio=function(){
				$scope.scoremaster = ({'productTypeCode':'1','subTypeCode':'1'});
				};
				$scope.LoadpresbbbRadio=function(){
				$scope.scoremaster = ({'productTypeCode':'2','subTypeCode':'1'});
				};
				$scope.LoadpreshbbRadio=function(){
				$scope.scoremaster = ({'productTypeCode':'3','subTypeCode':'1'});
				};
			$scope.Stage = [{"text": "SINGLE STAGE","id": "0"}, {"text": "DA","id": "1" },{ "text": "DB","id": "2"},
 { "text": "DC", "id": "3" },{ "text": "TA", "id": "4" },{ "text": "TB", "id": "5" },{ "text": "TC", "id": "5" }];
			...
			$index++;
			$scope.ScoremasterField.push({'id':$index,'guide':'H'+$index})
		 ...
		 $scope.PrestNeoField = [];
			...
			$index1++;
			$scope.PrestNeoField.push({'id':$index1,'guide':'PS'+$index1})
		 ...
		 /////////////
			...
			$index2++;
			$scope.bbbField.push({'id':$index2,'guide':'B'+$index2})
		...
		/////////////
		 $scope.hbbscoreField = [];
			...
			$index3++;
			$scope.hbbscoreField.push({'id':$index3,'guide':'HB'+$index3})
		...
		/////////////
		 $scope.gmscoreField = [];
			...
			$index4++;
			$scope.gmscoreField.push({'id':$index4,'guide':'GM'+$index4})
		...
		/////////////
		 $scope.gmreducerField = [];
			...
			//alert("enterd");
			$index5++;
			$scope.gmreducerField.push({'id':$index5,'guide':'GR'+$index5})
