...
function SmartWizard(target, options) 
{
    ...
    this.buttons = {
        next : $('<a ng-click="buttonNext(productSel);">'+options.labelNext+'</a>').attr("href","#/app/ProductSelection").addClass("buttonNext"),
        previous : $('<a ng-click="buttonPrevious();">'+options.labelPrevious+'</a>').attr("href","#/app/ProductSelection").addClass("buttonPrevious"),
        finish  : $('<a ng-click="buttonFinish();">'+options.labelFinish+'</a>').attr("href","#/app/ProductSelection").addClass("buttonFinish")
};
    ...
    SmartWizard.prototype.goForward = function()
	{
		...
		if(sessionStorage.getItem("formStatus")=="true")
		{
