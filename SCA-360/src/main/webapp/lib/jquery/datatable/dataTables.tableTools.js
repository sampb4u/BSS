...
/**
 * @summary     TableTools
 * @Jobs Tools and buttons for DataTables
 * @version     2.2.3
...
TableTools.prototype = {
	...
	/**
	 * Select rows
	 *  @param   {*} src Rows to select - see _fnSelectData for a Jobs of valid inputs
	 *  @private 
	 */
	...
	/**
	 * Deselect rows
	 *  @param   {*} src Rows to deselect - see _fnSelectData for a Jobs of valid inputs
	 *  @private 
	 */
