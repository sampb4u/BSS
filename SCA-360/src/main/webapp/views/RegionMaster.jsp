 ...
 <section id="content" data-ng-controller="RegionMaster" ng-init="loadCountryNames();addRegionForm();">  
	  ...
	  <select class="form-control" data-ng-model="AddRegion.countrycode" ng-options="countrycode.countrycode as countrycode.country for countrycode in countryNames | orderBy:'-country':true" name="countrycode"  ng-change="getRegions(AddRegion.countrycode);" >
			...
			<div class="col-sm-1">
				...
				<input type="text" class="form-control" ng-model="regiondata.regionCode"  ng-required="true"  name="regionCode{{$index}}"  size="5" ng-keyup="getvalidateRegionCode(regiondata.regionCode,$index);"  />
													...
													<input type="text"  class="form-control" ng-model="regiondata.region"  name="region{{$index}}" ng-required="true"  size="7" ng-blur="getvalidateRegion(regiondata.region,$index);"/>
					...
					<div class="col-sm-12" align="center">
						<button  id="buttonhide" type="submit" class="btn btn-blue" ng-click="regionSubmit(AddRegion,RegionMasterForm)">Save</button>
