...
<div   data-ng-controller="UpdateProgressController " ng-init="showPopup();loadupdatevalues();"> 
		    ...
		    <p class="popup__text">
				<div class="modal-body">
					<div class="row">
						...
						<div class="modal-body" id="pageHeadding1">
                    <div class="widget flat radius-bordered">
                             				<h3 style="font-weight:bold;">Update Progress</h3>
												<hr>
												</div>
												</div>
						...
						<form name="updateprogressform" novalidate ng-submit="">	
						<div class="row" >
				<div class="col-sm-6">
					<span class="input-icon icon-right"><input type="text" class="form-control" placeholder="Customer Name"  readonly ng-model="updateprogress.customer"  name="customer"/><i class="fa fa-user"></i>
                                                    </span>
													
				 <input type="hidden" class="form-control"    ng-model="updateprogress.salesman"  name="salesman"  readonly="true"/>										
				</div>
				<!--getProbabilitiesOnLoad(salesReport.quotationno);-->
				<div class="col-sm-6">
						<div class="form-group">                                
                  <span class="input-icon icon-right">
                                        <select class="form-control" data-ng-model="updateprogress.quotationno" ng-options="quotationno.qtnNo as quotationno.qtnNo for quotationno in quotationnodata " name="quotationno" 
										
ng-change="submitOnChange(updateprogress.quotationno,updateprogress.totalProbability,updateprogress.customer,updateprogress.salesman);">
					...
					<div class="row" align="center">
					     <div class="col-sm-9">
						     <div class="table-scrollable" style="width:75%">
							      <table style='width:100%; border-collapse:collapse;' border="1">
								         <thead class="bordered-blue">
											<tr>
											     <th  align="center">Progress Indicator</th>
												 <th id="">Probability</th>
												 <th align="center" >Achievement</th>
											</tr>
										</thead>
										<tr ng-repeat="progress in updateprogressData">
										    <td  width="5%" align="center"><div class="form-group" ><input type="hidden" class="form-control" ng-model="progress.indicator" name="indicator{{$index}}"/>{{progress.indicator}}</div></td>
											<td width="5%" align="center" ><div class="input-group" ><input type="hidden" class="form-control" ng-model="progress.probability"  name="probability{{$index}}"/>{{progress.probability}}%</div></td>
											<td width="5%" align="center"><div class="checkbox" ><label><input type="checkbox" class="colored-blue" name="probabilities{{$index}}"  ng-model="progress.probabilities" ng-checked="progress.probabilities=='true'" ng-click="changestatus(progress.probabilities,$index,updateprogress.totalProbability,progress.probability);calculatePercentage(progress.probability,progress.probabilities,updateprogress.quotationno,updateprogress.totalProbability);"/><span class="text"></span></label></div>
											</div></td>
					...
					<input type="text" class="form-control" placeholder="Total" name="totalProbability"  ng-model="updateprogress.totalProbability"/></div>
					 </div>
						  </div>
						<div class="row"  >
									<div class="col-sm-12" align="center">
<button type="submit" class="btn btn-blue" ng-click="saveProgressdetails(updateprogress.customer,updateprogress.quotationno,updateprogress.totalProbability,updateprogress.salesman);">Save</button>
										<button type="submit" class="btn btn-blue"  ng-click="Canceldetails();">Cancel</button>
									</div>
