...
<div   data-ng-controller="deliveryUpdateController " ng-init="showPopup();loaddeliveryvalues();"> 
		    ...
		    <p class="popup__text">
				<div class="modal-body">
                    ...
                    <div class="widget flat radius-bordered">
                             					<h3 style="font-weight:bold;">Delivery Update</h3>
												<hr>
												</div>
												</div>
						...
						<form name="deliveryreportform" novalidate ng-submit="">	
						<div class="row" >
						<div class="col-sm-2" align="right"><b>Customer:</b></div>
						<div class="col-sm-4" align="center">
			<div class="form-group">
		
			   <input type="text" class="form-control"    ng-model="deliveryUpdate.customer"  name="customer"  readonly="true"/>
                </div>                                   
			</div>
				 <input type="hidden" class="form-control"    ng-model="deliveryUpdate.salesman"  name="salesman"  readonly="true"/>		
						</div>
							<div class="row" >
								<div class="table-responsive"  id="deliveryshow1">
									<section class="asdok">
    ...
    <table ng-table="" class="table table-striped table-vmiddle">
											<thead>
													<tr>
														 ...
														 <th><span>QuotationNo</span></th>
														<th><span>quotationDate</span></th>
                                                        <th><span>exp.order.Date</span></th>
														<th><span>exp.del.Date</span></th>
														<th><span>proj.del.Date</span></th>
														</tr>
												</thead>
				
					<tbody>
				<tr ng-repeat="deliveryreport in deliveryreportData">
						
													
													
													<td > <input type="text"   class="form-control" ng-model="deliveryreport. quotationno"  name=" quotationno{{$index}}"  ng-disabled="true"/></td>
													<td > <input type="text"   class="form-control" ng-model="deliveryreport. quotationDate"  name=" quotationDate{{$index}}" ng-disabled="true"/></td>
													<td ><input type="text"   class="form-control datepicker" ng-model="deliveryreport. exporderDate"  ng-mouseover="ShowDatePicker();" name=" exporderDate{{$index}}" data-input-mask="{mask: '00-00-0000'}" data-ng-pattern="/(^(((0[1-9]|1[0-9]|2[0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\d\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/"/>
													</td>
												<td>	<input type="text"   class="form-control datepicker" ng-mouseover="ShowDatePicker();" ng-model="deliveryreport. expdelDate"  name=" expdelDate{{$index}}" data-input-mask="{mask: '00-00-0000'}" data-ng-pattern="/(^(((0[1-9]|1[0-9]|2[0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\d\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/"/></td>
												<td>	<input type="text"   class="form-control datepicker" ng-mouseover="ShowDatePicker();" ng-model="deliveryreport. projdelDate"  name=" projdelDate{{$index}}" data-input-mask="{mask: '00-00-0000'}" data-ng-pattern="/(^(((0[1-9]|1[0-9]|2[0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\d\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/"//></td>
				...
				<div class="row" >
									<div class="col-sm-12" align="center">
										<button type="submit" class="btn btn-blue"  ng-click="savedetails(deliveryUpdate.salesman,deliveryUpdate.customer);">Save</button>
