...
<div   data-ng-controller="viewnotesController " ng-init="showPopup();loadviewnotes();loadDates();"> 
		    ...
		    <p class="popup__text">
				<div class="modal-body">
                    ...
                    <div class="widget flat radius-bordered">
                             			<h3 style="font-weight:bold;">View Notes</h3>
												<hr>
												</div>
												</div>
				...
				<div class="form-group"  >
    		        					          ...
    		        					          <input type="text" class="form-control datepicker " placeholder="From Date" maxlength="10" name="fromdata" ng-model="fromdata" data-input-mask="{mask: '00-00-0000'}"   id=""  ng-mouseover="ShowDatePicker();"  data-ng-pattern="/(^(((0[1-9]|1[0-9]|2[0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\d\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/" ng-change="getCallNotes(fromdata,todate)"/>
					                	        </div>
                                                    </div>
				...
				<div class="col-sm-4">
						<div class="form-group" >
    		        					          ...
    		        					          <input type="text" class="form-control datepicker " placeholder="To Date" maxlength="10" name="todate" ng-model="todate" data-input-mask="{mask: '00-00-0000'}"   id=""  ng-mouseover="ShowDatePicker();"   data-ng-pattern="/(^(((0[1-9]|1[0-9]|2[0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\d\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/" ng-change="getCallNotes(fromdata,todate)"/>
                                                    </div>
				</div>
			</div>
					<div class="row" >
                                 <div class="col-sm-12">
                                     ...
                                     <div data-spy="scroll" style="height:250px; overflow-y:auto;">
                                           ...
                                           <div class="media-body">
                                                ...
                                                <ul class="list-inline list-unstyled">
                                                 ...
                                                 <li><span><i class="glyphicon glyphicon-calendar"></i> {{blogData.date}} </span></li>
												  <li><span> <p>{{blogData.remarks}}</p></span></li>
                                               </ul>
										  ...
										  <div class="well gridTableBlog">
											...
											<div ng-repeat="notes in callnotesData">
											<div class="row">
										<div class="col-sm-1" ><b>{{$index+1}}</b></div><div class="col-sm-3" style="font-size:14px;color:#33CCFF">{{notes.viewnotes}}</div>	
											</div>
											<div class="row">
											<div class="col-sm-1" ></div>
