...
<div ng-controller="QAServiceEXTController" ng-init="LoadStatusSelect();OnLoadQA();LoadQaExtRef();loadCustomerName();getReferenceNumber();assignToDepartments();LoadQaExtRef(QAEXTForm);">									
	<div class="well with-header with-footer">
      <div class="header bordered-blue" id="pageHeadding">QA External</div>
       
							
      
    <div class="container-fluid" >
    <form name="QAEXTForm"  novalidate>
                       ...
                       <div class="col-sm-3">
                            <div class="form-group">
								...
								<!-- <div  ng-class="{ 'has-error' : QAEXTForm.customer.$invalid && (QAEXTForm.customer.$dirty || submitted)}">
                                  <span class="input-icon icon-right">
                                  <label for="customer1"></label>																																																											
								    <input type="text" class="form-control" name="customer" ng-model="QAService.customer" id="customer1" placeholder="Customer" autocomplete="on" with-floating-label/>
									 <p ng-show="QAEXTForm.customer.$error.required && (QAEXTForm.customer.$dirty || submitted)" class="help-block"> Customer Name is required</p>

</div>      -->  
<span class="input-icon icon-right">
								  <div  ng-class="{ 'has-error' : QAEXTForm.customer.$invalid && (QAEXTForm.customer.$dirty || submitted)}">
                                 			<label for="CustomerCode"></label>																																																								
								   <!-- <input type="text" class="form-control"  data-ng-required="true" name="customer" ng-model="QAService.customer" id="customer1" placeholder="Customer Name"  with-floating-label/>-->
								   <input type="text" name="customerName" id="CustomerCode" ng-model="QAService.customer" placeholder="Customer Name" typeahead="customer.name as customer.name for customer in customernames | filter:{name:$viewValue}:startsWith  "  typeahead-no-results="noResults" typeahead-on-select='getCustomerStatus($item)'  class="form-control" typeahead-min-length='3'  autocomplete="off"  data-ng-required="true"  with-floating-label ng-disabled="{{disabled}}" />
					...
					<div ng-if="noResults" style="color: red;">No Results Found!</div>				
                       ...
                       <div class="col-sm-3">
                            <div class="form-group">
                                <div class="floating-label-wrapper">
                                  <span class="input-icon icon-right">
                                  <label for="customerCode"></label>																																																											
								    <input type="text" class="form-control" name="customerCode" ng-model="QAService.customerCode" id="customerCode" placeholder="Cust Code" autocomplete="on" with-floating-label ng-disabled="{{disabled}}"/>
                       ...
                       <div class="col-sm-3">
                            <div class="form-group">
                                <div class="floating-label-wrapper">
                                  <span class="input-icon icon-right">
								  <div  ng-class="{ 'has-error' : QAEXTForm.caseReferenceNumber.$invalid && (QAEXTForm.caseReferenceNumber.$dirty || submitted)}">
                                  <label for="caseReferenceNumber1"></label>																																																											
								    <input type="text" class="form-control"    ng-blur="DupextRef(QAService.caseReferenceNumber);"  name="caseReferenceNumber" ng-model="QAService.caseReferenceNumber" id="caseReferenceNumber1" placeholder="Case Reference"  ng-disabled="true"  with-floating-label ng-disabled="{{disabled}}"/>
									<p id="existValEXT" class="help-block" style="color:#FF0000; display:none;" ng-if="QAService.caseReferenceNumber!=null">caseReference Number Already Exist</p>
                         <p ng-show="QAEXTForm.caseReferenceNumber.$error.required && (QAEXTForm.caseReferenceNumber.$dirty || submitted)" class="help-block"> Case Reference No. is required</p>
					   ...
					   <div class="col-sm-3">
                                    <div class="form-group">
                                        <div class="floating-label-wrapper">
                                          ...
                                          <label for="contactno"></label>																																																											
                                            <input type="text" class="form-control" name="contactno" ng-model="QAService.contactno" id="contactno" placeholder="Contact" with-floating-label ng-disabled="{{disabled}}"/>
                           ...
                           <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="floating-label-wrapper">
                                          ...
                                          <label for="telephoneno"></label>																																																											
                                            <input type="text" class="form-control" name="telephoneno" ng-model="QAService.telephoneno" id="telephoneno" placeholder="Tel"  with-floating-label ng-disabled="{{disabled}}"/>
                               ...
                               <div class="col-sm-3">
                                    <div class="form-group">
                                                      <div class="floating-label-wrapper" >
                                                            <span class="input-icon icon-right">
                                                                <select class="form-control" ng-model = "QAService.status" name = "status"   id="status" placeholder="Status"  ng-options="status.label as status.label for status in customerStatusdata " with-floating-label ng-disabled="{{disabled}}">
                               ...
                               <div class="col-sm-6">
                                    ...
                                    <textarea cols="50" rows="1" placeholder="Address" id="address" class="form-control" name="address" ng-model="QAService.address" with-floating-label ng-disabled="{{disabled}}"></textarea>
                                    </div>
                                    </div>
                               </div>
                           </div>
                           ...
                           <div class="row">
                               <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="subject" ng-model="QAService.subject" id="title" placeholder="Subject"  with-floating-label ng-disabled="{{disabled}}"/>
                           ...
                           <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="floating-label-wrapper">
                                        <span class="input-icon icon-right">
                                      <label for="gearHeadslno"></label>																																																											
                                            <input type="text" class="form-control" name="gearHeadslno" ng-model="QAService.gearHeadslno"  id="gearHeadslno" placeholder="Gearhead Serial No." with-floating-label ng-disabled="{{disabled}}"/>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">																																																											
                                            <div class="floating-label-wrapper">
                                        <span class="input-icon icon-right">
                                      <label for="motorslno"></label>																																																											
                                            <input type="text" class="form-control" name="motorslno" ng-model="QAService.motorslno"  id="motorslno" placeholder="Motor Serial No." with-floating-label ng-disabled="{{disabled}}"/>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">																																																											
                                            <div class="floating-label-wrapper">
                                        <span class="input-icon icon-right">
                                      <label for="shimfgno"></label>																																																											
                                            <input type="text" class="form-control" name="shimfgno" ng-model="QAService.shimfgno"  id="shimfgno" placeholder="SHI Mfg No." with-floating-label ng-disabled="{{disabled}}"/>
                                ...
                                <div class="col-sm-5">
                                	<div class="row">
                                    <div class="col-sm-4">
                                        <b style="color:#666666;">QA (Ext) for : </b>
                                   ...
                                   <div class="control-group"> 
									   <p>
<label ng-repeat="fruitName2 in qaIssuesFor2">
  <input
    type="checkbox" class="colored-blue" 
    name="qaIssuesFor[]"
    value="{{fruitName2.id}}"
    ng-checked="fruitSelection3.indexOf(fruitName2.id) > -1"
	ng-model="fruitName2.qaIssuesFor"
	 ng-click="testId3(fruitName2.id);"
   
 ng-disabled="{{disabled}}"/ ><span class="text" style="width:260px;">{{fruitName2.text}}</span>
</label>
</p>   <br/><br/>
                                   ...
                                   <div class="control-group">
                                           <div class="radio" > 
  <p>
<label ng-repeat="fruitName3 in actionRequired2">
  <input
    type="checkbox" class="colored-blue" 
    name="actionRequired[]"
    value="{{fruitName3.id}}"
    ng-checked="fruitSelection4.indexOf(fruitName3.id) > -1"
	ng-model="fruitName3.actionRequired"
	 ng-click="testId4(fruitName3.id);getAssingnedDeptExt(fruitName3.id,fruitName3.actionRequired);"
   
 ng-disabled="{{disabled}}" / ><span class="text" style="width:260px;">{{fruitName3.text}}</span>
</label>
</p>  <br/><br/>
                                ...
                                <div class="col-sm-12"><div class="form-group">
                                                      <div class="floating-label-wrapper" >
															...
															<label>Assigned To</label>
                                                              <!--  <select class="form-control" ng-model = "QAService.assignedTo" name = "assignedTo"   id="assignto" placeholder="Assigned To"  ng-options="assignedTo.assigned as assignedTo.assigned for assignedTo in assigntodata " with-floating-label ng-disabled="{{disabled}}">
                                                                <option value=""> Assigned To</option>
															
                                                                
                                                            </select>-->
													<select  placeholder="Assigned To" class="chosen-select" multiple id="picturegallery" name="assignedTo" data-ng-required="true"  data-ng-model="QAService.assignedTo"  >
                                ...
                                <div class="col-sm-7" style="border:1px solid #666666; padding:20px 10px 10px 10px;margin: 0px 0px 0px -15px;width: 58%;">
                                	
                                    	<div class="row">
                                        <div class="col-sm-4">
                                        <div class="floating-label-wrapper">
                                        <label for="scaClaimno"></label>
                                        <input type="text" class="form-control" name="scaClaimno" ng-model="QAService.scaClaimno" id="scaClaimno" placeholder="SCA Claim No." with-floating-label ng-disabled="{{disabled}}"/>
                                        </div>
                                        </div>
                                         <div class="col-sm-4">
                                          <div class="floating-label-wrapper">
										   <label for="scadate"></label>
                                         <input type="text"   class="form-control datepicker" ng-model="QAService.scaDate"  ng-mouseover="ShowDatePicker();" name=" scaDate" data-input-mask="{mask: '00-00-0000'}" data-ng-pattern="/(^(((0[1-9]|1[0-9]|2[0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\d\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/" with-floating-label id="scadate" placeholder="SCA Date"  ng-disabled="{{disabled}}"/>
                                          </div>
                                        </div>
                                         <div class="col-sm-4">
                                         <div class="floating-label-wrapper">
                                        <label for="scaOrderno"></label>
                                          <input type="text" class="form-control" placeholder="SCA Order No." name="scaOrderno" ng-model="QAService.scaOrderno" id="scaOrderno"  with-floating-label ng-disabled="{{disabled}}"/>
                                          </div>
                                        </div>
                                        </div>
                                        <br />
                                        ...
                                        <input type="text" class="form-control" placeholder="Model" name="model" ng-model="QAService.model" id="model"  with-floating-label/>
                                        </div>
                                        </div>
                                         <div class="col-sm-6">
                                         <div class="floating-label-wrapper">
                                        <label for="serialno"></label>
                                          <input type="text" class="form-control" placeholder="Serial No." name="serialno" ng-model="QAService.serialno" id="serialno" ng-blur="duplicateSerialNo(QAService.serialno);"  with-floating-label ng-disabled="{{disabled}}"/>
                                          </div>
                                        </div>
                                        </div>
                                         <br />
                                        ...
                                        <input type="text" class="form-control"   placeholder="Item Description" name="itemDescription" ng-model="QAService.itemDescription" id="itemDescription"  with-floating-label ng-disabled="{{disabled}}"/>
                                        </div>
                                        </div>
                                         <div class="col-sm-2">
                                         <div class="floating-label-wrapper">
										  ...
										  <label for="quantity"></label>
                                              <input type="text" class="form-control" placeholder="Qty" name="qty" ng-model="QAService.qty" id="quantity"  with-floating-label/>
                                              </div>
                                        </div>
                                        ...
                                        <input type="text" class="form-control" placeholder="Part No." name="partno" ng-model="QAService.partno" id="partno"  with-floating-label ng-disabled="{{disabled}}"/>
                                        </div>
                                        </div>
                                         <div class="col-sm-6">
                                         <div class="floating-label-wrapper">
                                        <label for="pageitemno"></label>
                                          <input type="text" class="form-control" placeholder="Page Item No." name="pageitemno" ng-model="QAService.pageitemno" id="pageitemno"  with-floating-label ng-disabled="{{disabled}}"/>
                                          </div>
                                        </div>
                                ...
                                <div class="control-group">
									<label>
										<b style="color:#666666;">Warranty Period Valid </b>  <input name="warrantyValid" type="radio" class="colored-blue"  value="0" ng-model="QAService.warrantyValid" checked="checked"  ng-disabled="{{disabled}}"/>
										<span class="text">Yes</span>
									</label>
									&nbsp;&nbsp;
									<label>
										<input name="attachDrawing" type="radio" class="colored-blue" ng-model="QAService.warrantyValid" value="1" name="warrantyValid" />
										<span class="text">No</span>
                                         ...
                                         <div class="col-sm-6">
                                         <div class="floating-label-wrapper">
                                        <label for="shipInvoiceno"></label>
                                          <input type="text" class="form-control" placeholder="SHI Invoice No." name="shipInvoiceno" ng-model="QAService.shipInvoiceno" id="shipInvoiceno"  with-floating-label ng-disabled="{{disabled}}"/>
                                          </div>
                                        </div>
                                        ...
                                        <div class="floating-label-wrapper">
											    ...
											    <input type="text"   class="form-control datepicker" ng-model="QAService.shipmentDate"  ng-mouseover="ShowDatePicker();" name=" shipmentDate" data-input-mask="{mask: '00-00-0000'}" data-ng-pattern="/(^(((0[1-9]|1[0-9]|2[0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\d\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/" with-floating-label id="scadate" placeholder="ShipmentDate"   ng-disabled="{{disabled}}"/>
											</div>
                                        </div>
                                         ...
                                         <div class="floating-label-wrapper">
											    ...
											    <input type="text"   class="form-control datepicker" ng-model="QAService.recievingDate"  ng-mouseover="ShowDatePicker();" name=" recievingDate" data-input-mask="{mask: '00-00-0000'}" data-ng-pattern="/(^(((0[1-9]|1[0-9]|2[0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\d\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/" with-floating-label id="scadate" placeholder="RecievingDate" ng-disabled="{{disabled}}" />
											</div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                        <div class="floating-label-wrapper">
                                        <label for="blorawbno"></label>
                                        <input type="text" class="form-control" placeholder="B/L or AWB No." name="blorawbno" ng-model="QAService.blorawbno" id="blorawbno"  with-floating-label ng-disabled="{{disabled}}"/>
                                        </div>
                                        </div>
                                         <div class="col-sm-6">
                                         <div class="floating-label-wrapper">
                                        <label for="vesselOrFlightno"></label>
                                          <input type="text" class="form-control" placeholder="Vessel or Flight No." name="vesselOrFlightno" ng-model="QAService.vesselOrFlightno" id="vesselOrFlightno"  with-floating-label ng-disabled="{{disabled}}"/>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                        <div class="floating-label-wrapper">
                                        <label for="qtyDamazed"></label>
                                        <input type="text" class="form-control" placeholder="Qty Damaged" name="qtyDamazed" ng-model="QAService.qtyDamazed" id="qtyDamazed"  with-floating-label ng-disabled="{{disabled}}"/>
                                        </div>
                                        </div>
                                         <div class="col-sm-2">
                                         <div class="floating-label-wrapper">
                                        <label for="outOf"></label>
                                          <input type="text" class="form-control" placeholder="Out of" name="outOf" ng-model="QAService.outOf" id="outOf"  with-floating-label/>
                                          </div>
                                        </div>
                                         <div class="col-sm-4">
                                         <div class="floating-label-wrapper">
                                        <label for="inPackageno"></label>
                                          <input type="text" class="form-control" placeholder="In Package No." name="inPackageno" ng-model="QAService.inPackageno" id="inPackageno"  with-floating-label ng-disabled="{{disabled}}"/>
                                          </div>
                                        </div>
                                        </div>
                                        <br />
                                        ...
                                        <div class="col-sm-6">
                                        <div class="floating-label-wrapper">
                                        <label for="salesorder"></label>
                                        <input type="text" class="form-control" placeholder="SalesMan Name" name="salesManName" ng-model="QAService.salesManName" id="salesorder"  with-floating-label ng-disabled="{{disabled}}"/>
                                        </div>
                                        </div>
                                         <div class="col-sm-6">
                                         <div class="floating-label-wrapper">
                                        <label for="salescode"></label>
                                          <input type="text" class="form-control" placeholder="SalesMan Code" name="salesManCode" ng-model="QAService.salesManCode" id="salescode"  with-floating-label ng-disabled="{{disabled}}"/>
                                          </div>
                                        </div>
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-12">
                             ...
                             <div class="col-sm-12">
                                ...
                                <table class="table" border="0px solid #000000"style="border-collapse:collapse;">
                                 ...
                                 <label for="qaIssuesDescription"></label><textarea cols="50" rows="2" placeholder="Description of the QA (Ext):" class="form-control" name="qaIssuesDescription" id="qaIssuesDescription" ng-model="QAService.qaIssuesDescription" with-floating-label ng-disabled="{{disabled}}"></textarea></div></td><td></td><td></td></tr>
                                        
                                        <!--<tr><td colspan="4"><div class="floating-label-wrapper">
                                 <label for="possibleReasonsRemarks"></label><input type="text" class="form-control" placeholder="Possible Reason of problem & Remarks:"  id="possibleReasonsRemarks" ng-model="QAService.possibleReasonsRemarks" name="possibleReasonsRemarks" with-floating-label/></div></td></tr>-->
									</tbody>
								</table>
                                ...
                                <div class="form-group" id="remarksHide">
                                    ...
                                    <span class="input-icon icon-right">
                                     <label for="Remarks"></label> 
                                        <textarea class="form-control" rows="1"  placeholder="Remarks:" name="possibleReasonsRemarks" ng-model="QAService.possibleReasonsRemarks" id="Remarks"  with-floating-label ng-disabled="{{disabled}}"></textarea>
                                    ...
                                    <p ng-show="newSelectionForm.remarks.$error.maxlength  && (newSelectionForm.remarks.$dirty || submitted)" class="help-block">Too Long </p>-->
                                      ...
                                      <div class="input-group">
                                       <button type="button" class="btn btn-primary"  ng-click="addRemarkQAext(QAService.possibleReasonsRemarks,QAService.caseReferenceNumber,QAService.salesManName);" ng-disabled="{{disabled}}">Save Remarks</button>
                                       </div>
                                    </div>
                                </div>
								</div>
						 <div class="row" id="blogHide">
							...
							<!--<div class="well gridTableBlog">
											...
											<div ng-repeat="blogData in addedRemarksData">
											<div class="row">
										<div class="col-sm-1" ><b>{{$index+1}}</b></div><div class="col-sm-3" style="font-size:14px;color:#33CCFF">{{blogData.username}}</div>	
											</div>
											<div class="row">
											<div class="col-sm-1" ></div>
											<div class="col-sm-3" style="font-size:17px;color:#000000"><b><span><i class="glyphicon glyphicon-calendar">{{notes.notesdate}}</i></span></b></div>
                 ...
                 <!--<div class="row" >
					<div class="col-sm-12" align="center">
						<button type="submit" class="btn btn-blue"  ng-click="">Save</button>
						<button type="reset" class="btn btn-blue"  ng-click="">Reset</button>
				...
				<div class="row" >
					<div class="col-sm-12" align="center">
						<!--<button type="button" class="btn btn-default"  ><i class="fa fa-file-pdf-o" aria-hidden="true"></i>
 Print PDF</button>-->
						<button type="submit" class="btn btn-blue"   ng-click="QualExtSubmit(QAEXTForm,QAService);" id="DisableSave" ng-disabled="{{disabled}}"><i class="glyphicon glyphicon-save"></i> Save</button>
						<button type="button" class="btn btn-success"  ng-click="QualExtaveAndSendFormSubmit(QAEXTForm,QAService);"  id="DisableSaveAndSend" ng-disabled="{{disabled}}"><i class="glyphicon glyphicon-envelope"></i> Save & Send</button>
						...
						<button type="button"  class="btn btn-danger" ng-click="resetQaExtForm(QAEXTForm)"  ng-disabled="{{disabled}}"><i class="glyphicon glyphicon-trash" ></i> Delete<!--<img src="image/dustbin.jpg"  class="pointer"  data-toggle="tooltip" title="Delete"  style="width:40px;height:30px; " alt="" >--></button>
					...
					<div class="row">
     					<div class="col-lg-12 col-sm-12 col-xs-12">                						
							<div class="row">
     							<div class="col-lg-12 col-sm-12 col-xs-12">  
                                	<div class="modal-body">
								<div class="row" align="center" >	<span style="text-align:center">	<b class="heading">This  Serial No &nbsp; <span style="color: #00ff00">{{SerialNumber}}</span> &nbsp; Already Exist For <br/><span style="color: #00ff00">{{DisplayName}}</span> with Reference No <span style="color: #00ff00">{{CaseReferenceNumber}}.</span>  </b></span></div>
								<br/>
								<br/>
								<div class="row" >
					<div class="col-sm-12" align="center">
						<button type="submit" class="btn btn-blue"  ng-click="GoToQAService(CaseReferenceNumber,DisplayName);">View</button>
					<!--	<button type="submit" class="btn btn-blue"  ng-click="CancelPopdetails();">Cancel</button>-->
					</div>
					<div class="col-sm-6"></div>
