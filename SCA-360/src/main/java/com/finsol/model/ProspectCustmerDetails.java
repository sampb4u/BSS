 ...
 */
@Entity
public class ProspectCustmerDetails {
	...
	private List<ProspectCustmerContactDetails> rolescreens;
	...
	public List<ProspectCustmerContactDetails> getRolescreens() {
		return rolescreens;
	}

	public void setRolescreens(List<ProspectCustmerContactDetails> rolescreens) {
