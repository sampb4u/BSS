...
public class CompititorGridTemp 
{
	...
	public String getCompititorcode() {
		return compititorcode;
	}

	public void setCompititorcode(String compititorcode) {
		this.compititorcode = compititorcode;
	}
